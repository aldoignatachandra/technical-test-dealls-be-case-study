...
import { ReimbursementData } from "../../types";
import { idValidation } from "../../validations/general";
import { show } from "../../modules/services/reimbursement";

export const CheckerPipe = async (c: Context): Promise<ReimbursementData> => {
  const body = { id: c.req.param("reimbursement_id") };
  ...
  // Check If User Is Not Admin, Only Can Acces Their Own Reimbursement
